...
export default function FixingPage() {
  return (
    <SecurityFrame title="How We Fix Security Issues">
      <SecurityLayout title="How We Fix Security Issues" showTitle>
        <p>
        ...
        <h3>Tested</h3>
        <p>Security fixes by the Jenkins security team will have corresponding autotests confirming they work as expected.</p>
        <p>
          <strong>NOTE:</strong> This also means that in many cases, fixes for vulnerabilities include test code that can be considered proof-of-concept exploits. We believe that the advantages of confirming that security fixes work, and remain working in the future, outweigh the downsides of giving attackers a slight advantage.
        </p>
      </SecurityLayout>
    </SecurityFrame>
  );
