...
export default function ChangelogWeeklyPage() {
  ...
  return (
    ...
    >
      <Helmet>
        ...
        <meta name="description" content="Changelog for Jenkins weekly releases" />
      </Helmet>
      ...
      <div className="app-app-bar">
        ...
        <div className="app-app-bar__controls app-controls">
          <a className="app-rss" href="/changelog/rss.xml" aria-label="RSS">
      ...
      <div className="app-banner">
        ...
        <a href="/changelog-old/">in the changelog archive.</a>
      </div>
    </Box>
  );
}
