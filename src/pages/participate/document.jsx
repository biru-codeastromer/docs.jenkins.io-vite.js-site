import { Box, Typography, Link, Table, TableBody, TableCell, TableHead, TableRow } from '@mui/material';
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Typography component="ul" sx={{ pl: 4, mb: 2 }}>
        <li><Link href="https://github.com/jenkins-infra/jenkins.io/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22">Newbie-friendly documentation tasks</Link></li>
        <li><Link href="https://github.com/jenkins-infra/jenkins.io/issues?q=is%3Aopen+is%3Aissue">More advanced documentation tasks</Link> (no <code>good first issue</code> label set)</li>
        <li><Link href="/sigs/docs/">Documentation SIG Page</Link> with links to the Jenkins documentation</li>
        <li><Link href="https://help.github.com/en/github/writing-on-github/about-writing-and-formatting-on-github">Writing and Formatting on GitHub</Link> (applies to Github Markdown documentation)</li>
      </Typography>
